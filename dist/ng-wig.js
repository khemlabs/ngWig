...
angular.module('ngWig').component('ngWig', {
	...
	controller: [
		...
		'fileService',
		'ngWigToolbar',
		function($scope, $element, $q, $attrs, $window, $document, $mdDialog, __env, fileService, ngWigToolbar) {
			var _this = this;
			...
			this.execCommand = function(command, options) {
				...
				if (command === 'createlink' || command == 'insertImage') return _this.fileCommand(command, options);
			...
			this.$onInit = function() {
				...
				_this.ngModelController.$render = function() {
					return _this.ngModelController.$viewValue
						? $container.html(_this.ngModelController.$viewValue)
						: placeholder ? $container.empty() : $container.html('<p></p>');
				};
...
angular.module('ng-wig/views/ng-wig.html', []).run([
	'$templateCache',
	function($templateCache) {
		$templateCache.put(
			'ng-wig/views/ng-wig.html',
			'<div class="ng-wig">\n' +
				'  <ul class="nw-toolbar">\n' +
